...
{
    public WayCreator[] pathFollow;  // asignación de rutas
    ...
    void Start()
    {
        ...
        currentWayPointID = 0;  // inicialización del primer punto de la ruta
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0) && !hasFallen)  // Detectar el click 
        {
            RaycastHit hit;
